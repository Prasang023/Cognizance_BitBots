...
contract Push is ERC20 {
    ...
    function transfer(address to, uint amount) override public returns (bool success) {
        ...
        IPUSHCommInterface(EPNS_COMM_ADDRESS).sendNotification(
            0x7eff959E7D7fB6b9F3cDA78599966870929A7628, // from channel - recommended to set channel via dApp and put it's value -> then once contract is deployed, go back and add the contract address as delegate for your channel
